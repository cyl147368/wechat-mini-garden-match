...
if (!logic.hasPossibleMove(state.board)) fail("generated board has no possible move");
if (logic.findMatches(state.board).cells.length) fail("generated board starts with a match");
